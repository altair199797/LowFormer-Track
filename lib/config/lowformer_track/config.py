...
## ADDED BY ME
cfg.MODEL.TEMPORAL_TEMPLATE = False
cfg.MODEL.OLDWAY = False
cfg.MODEL.LOW_FEAT_FUSE = False
cfg.MODEL.LOW_FEAT_FUSEV2 = False
cfg.MODEL.LOW_FEAT_FUSEV3 = False
cfg.MODEL.LOW_FEAT_FUSEV4 = False
cfg.MODEL.BB_STAGE_LAST = False
cfg.MODEL.NO_POSTPROCESS = False
cfg.MODEL.RETURN_TEMPLATE = False
cfg.MODEL.NO_TEMPLATE_FEATS = False
cfg.MODEL.ADD_BACKBONE_LAYER = False
cfg.MODEL.PREPEND_LAYER = False 
...
cfg.TRAIN = edict()
### ADDED BY ME
cfg.TRAIN.NO_GRAD_BACKBONE = False
