...
class LaSOTDataset(BaseDataset):
    ...
    #  /media/TBDataNAS/Visual Object Tracking/LaSOTBenchmark/airplane/airplane-1/groundtruth.txt

    def _construct_sequence(self, sequence_name):
        class_name = sequence_name.split('-')[0]
        # anno_path = '{}/{}/{}/groundtruth.txt'.format(self.base_path, class_name, sequence_name)
        anno_path = '{}/{}/groundtruth.txt'.format(self.base_path, os.path.join(class_name ,sequence_name))

        # for ind, i in enumerate(anno_path.split("/")):
        #     # print(anno_path.split("/")[:ind+1],anno_path.split("/") )
        #     print(os.listdir("/".join(anno_path.split("/")[:ind+2])))
